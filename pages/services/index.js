    ...
    <div className=' container mx-auto'>
      <div className='flex flex-col  xl:flex-row gap-x-6 '>
        <div className='text-center flex xl:w-[40vw] flex-col lg:text-left mb-4'>
          ...
          <motion.p variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit="hidden" className='mb-4 max-w-[400px] mx-auto lg:mx-0'>Empowering your digital presence with comprehensive web solutions. From concept to code, ensuring quality at every step.</motion.p>
        </div>
